...
#             channel_obj = ChannelMessage.objects.create(
...
#             my_channel_obj, _ = Channel.objects.get_or_create_current_user_private_message(
#                 self.request.user)
#             return my_channel_obj
#         channel_obj, _ = Channel.objects.get_or_create_private_message(
...
#     channel_obj, created = Channel.objects.get_or_create_private_message(
#         my_username, username)
#     if created:
#         print("yes it was")
